...
void CToolApp::CreateTestScene()
{
	...
	CResPtr<CTexture> pHeightMap = CResMgr::GetInst()->CreateTexture(L"HeightMap", 100, 100, D3D11_BIND_SHADER_RESOURCE | D3D11_BIND_UNORDERED_ACCESS, D3D11_USAGE_DEFAULT, DXGI_FORMAT_R32G32B32A32_FLOAT);
