...
{
	CPathMgr::init();
	wstring strProjPath = CPathMgr::GetSolutionPath();
	wstring strCppPath = strProjPath + L"04. Script\\ScriptMgr.cpp";
	wstring strHeaderPath = strProjPath + L"04. Script\\ScriptMgr.h";

	// 1. 현재 존재하는 모든 스크립트를 알아내야함.
	wstring strScriptCode = strProjPath + L"04. Script\\";
