...
CPlatformLeftCollisionScript::CPlatformLeftCollisionScript():
	CScript((UINT)SCRIPT_TYPE::PLATFORMLEFTCOLLISIONSCRIPT)
{
}
...
void CPlatformLeftCollisionScript::OnCollisionEnter(CCollider2D * _pOther)
{
	collisionOn = true;
...
void CPlatformLeftCollisionScript::OnCollision(CCollider2D * _pOther)
{
	if (collisionOn == true)
	{
		vector<CScript*> parentScripts;
...
void CPlatformLeftCollisionScript::OnCollisionExit(CCollider2D * _pOther)
{
	collisionOn = false;
